...
--
-- Host: localhost:3306
-- Generation Time: Apr 27, 2019 at 08:13 PM
...
CREATE TABLE `pages` (
  ...
  `og_url` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `questions` (`id`, `question`, `option_1`, `option_2`, `option_3`, `option_4`, `right_ans`, `category_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 'The train goes ______ many tunnels on the way to Rome.', 'in', 'to', 'through', 'over', '1', 1, 1, '2019-04-27 18:00:00', NULL);
