...
<body>
    <div class="email">
	  <p>Dear Admin, A new Query From  {{@$msg->name}}</p>
	  <p>Subject: {{$msg->subject}}</p>
	  <p>Name: {{@$msg->name}}</p>
	  <p>From: {{@$msg->email}}</p>
	  <p>phone: {{@$msg->phone}}</p>
	  <p>Message : {{@$msg->message}}</p>
	  <p>Send At: {{$msg->created_at}}</p>
	  ...
	  <table border="0" cellspacing="0" cellpadding="0" width="100%" style="width:100%;border-top: 3px dashed #eee;padding-top:20px;margin-top: 40px;">
	    <tbody>
	      <tr valign="top">
	        ...
	        <td>
	          <div class="signature-name">This Email is Sent From <br> <span class="signature-title">Infinity Workforce</span> </div>
