			...
			<div class="col-md-12">
				<div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('user/certificate/download')}}/{{$certificate->id}}" title="Take Quiz" class="btn btn-info" target="_blank"><i class="ti-download"></i></a>
                                            <a href="{{url('user/take-quiz')}}/{{@$certificate->category->id}}" title="Take Quiz" class="btn btn-info"><i class="ti-share-alt"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            @else
                            <p class="text-warning"><i class="fa fa-warning"></i> No Certificate Available</p>
                            @endif
                        </div>
                    </div>
			</div>
