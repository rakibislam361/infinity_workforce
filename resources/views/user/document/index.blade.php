										...
										<tr>
											...
											<td class="text-center">
												@foreach($user->doc_images as $doc)
													<a href="{{asset('images/user-documents/images',$doc->file)}}" download>
									...
									@if($user->doc_visas->count()>0)
										<tr>
											...
											<td>
												...
												<a href="{{asset('images/user-documents/visa')}}/{{$doc->file}}" target="_blank" download>
													<i class="ti-download" title="Dwonload"></i>
												</a>
												@endforeach
											</td>
						...
						<form action="{{route('user-document-upload')}}" enctype="multipart/form-data" method="post">
							...
							<div class="row mt-3">
								<div class="form-group col-md-4">
	                                ...
	                                <input id="doc_image" name="doc_image" type="file" class="form-control" aria-required="true" aria-invalid="false" placeholder="" value="" accept="image/png, image/jpeg,image/jpg,image/bmp" required="">
	                                <span class="text-danger"> {{ $errors->first('doc_image') }}</span>
	                            </div>
	                            <div class="form-group col-md-4">
	                                <label for="image" class="control-label mb-1">VISA / CITIZENSHIP <small>Australian Document *</small></label>
	                                <input id="visa_copy" name="visa_copy" type="file" class="form-control" aria-required="true" aria-invalid="false" placeholder="" value="" accept="file/pdf,image/png, image/jpeg,image/jpg,image/bmp,.doc,.docx,application/msword" required="">
	                                <span class="text-danger"> {{ $errors->first('visa_copy') }}</span>
	                            </div>
	                            <div class="form-group col-md-4">
	                                <label for="resume" class="control-label mb-1">RESUME <small>Your Professional Documents</small></label>
	                                <input id="resume" name="resume" type="file" class="form-control" aria-required="true" aria-invalid="false" placeholder="" value="" accept="file/pdf,image/png, image/jpeg,image/jpg,image/bmp,.doc,.docx,application/msword" required="">
	                                <span class="text-danger"> {{ $errors->first('resume') }}</span>
	                            </div>
							</div>
							<div class="row mt-3">
								<div class="form-group col-md-4">
	                                <label for="police_clearance" class="control-label mb-1">POLICE RECORD  <br/><small>Australian Document</small></label>
	                            ...
	                            <div class="form-group col-md-4">
	                                <label for="medical_certificate" class="control-label mb-1">FIT TO WORK MEDICAL CERTIFICATE <br/><small>Australian Document</small></label>
	                            ...
	                            <div class="form-group col-md-4">
	                                <label for="image" class="control-label mb-1">DRIVE LICENCE<br/> <small>Australian Document</small></label>
