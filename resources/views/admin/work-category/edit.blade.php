...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{url('admin/work-category/update')}}/{{$category->id}}" method="post"{{--  enctype="multipart/form-data" --}}>
                @csrf
            <div class="row">
                <div class="form-group col-md-12">
                    <strong for="question" class="control-label mb-1">Title<small class="text-danger">*</small></strong>
                    <input id="title" name="title" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Title" required="" value="{{$category->name}}">
                ...
                <div class="form-group col-md-6 mt-3">
                    <div class="mt-3">
                        ...
                        <label class="switch switch-green status">
                          <input type="checkbox" class="switch-input" value="1" name="status" @if($category->status==1) checked @endif>
