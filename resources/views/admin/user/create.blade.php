                    ...
                    <div class="card-body">
                        <form action="{{ route('admin-user-store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="email" class="control-label mb-1">Email <small
                            ...
                            <div class="row mt-2">
                                <div class="form-group col-md-3">
                                    <label for="dob" class="control-label mb-1">Date of birth <small
                                            class="text-danger">*</small></label>
                                    <input id="dob" name="dob" type="date" class="form-control" aria-required="true"
                                        aria-invalid="false" placeholder="" required="">
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="" class="bold">Photo</label><br />
                                    <div class="form-check form-check-inline">
                                        <input name="radio" class="form-check-input" type="radio" id="inlineRadio1"
                                            value="2">
                                        <label class="form-check-label" for="inlineRadio1">Camera</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input name="radio" class="form-check-input" type="radio" id="inlineRadio2"
                                            value="1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="exampleFormControlTextarea1"
                                                style="margin-left: 70px;">Webcam</label>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="exampleFormControlTextarea1"
                                                style="margin-left: 70px;">Picture</label>
