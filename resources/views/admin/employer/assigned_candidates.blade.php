                    ...
                    <form action="{{url('admin/assigned_candidate/search')}}" method="get">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <input type="number" name="can_id" class="form-control" placeholder="Search By ID"
                                    value="{{@$data_id}}">
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                <input type="text" name="suburb" class="form-control" placeholder="Search By Suburb"
                                    value="{{@$data_suburb}}">
                            </div>
                            <div class="col-md-3">
        ...
        <div class="card">
            <div class="card-header ">
                ...
                <div class="text-right">
                    <a href="{{route('admin-user-create')}}" title="Add New User" class="btn btn-info btn-sm">Add
                        New</a>
                </div>
            </div>
                ...
                <form action="{{route('admin-assigned-candidates')}}" method="post">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="text-danger text-left"><i class="fa fa-warning"></i> Please select at least one
                                candidate</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row"><label><input type="checkbox" value="{{@$candidate->id}}"
                                            name="assigned[]"> {{++$key}}</label></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="user-menu dropdown-menu">
                                            <a class="nav-link" href="{{route('admin-user-show',$candidate->id)}}"><i
                                                    class="ti-eye mr-1"></i>View</a>
                                            <a class="nav-link" href="{{route('admin-user-edit',$candidate->id)}}"><i
                                                    class="ti-pencil-alt mr-1"></i>Edit</a>
