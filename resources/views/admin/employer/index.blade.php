                ...
                <div class="card">
                    <div class="card-header ">
                        ...
                        <div class="text-right">
                            <a href="{{ route('admin-employer-create') }}" title="Add New User"
                            ...
                            <tbody>
                                @foreach ($companies as $key => $company)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ url('admin/employer/status') }}/{{ $company->id }}"
                                                method="post" class="status">
                                                @csrf
                                                <label class="switch switch-green status">
                                                    <input type="checkbox" class="switch-input"
                                                        {{ @$company->status == 1 ? 'checked' : '' }} value="1"
                                                        name="status">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="user-menu dropdown-menu">
                                                    <a class="nav-link"
                                                        href="{{ route('admin-employer-profile', $company->id) }}"><i
                                                            class="ti-eye mr-1"></i>Profile</a>
