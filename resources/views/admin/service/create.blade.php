    ...
    <div class="card-body">
        <form action="{{url('admin/service/store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <strong for="question" class="control-label mb-1">Description</strong>
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea name="short_desc" class="form-control">{{old('desc')}}</textarea>
                    <span class="text-danger"> {{ $errors->first('short_desc') }}</span>
                </div>
                <div class="form-group col-md-12 mt-3">
                    <strong for="question" class="control-label mb-1">Short Description Link</strong>
                    <input id="link" name="link" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Link" value="{{old('link')}}">
