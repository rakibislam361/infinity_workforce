			...
			<div class="col-md-12">
				<div class="card">
                        <div class="card-header ">
                            <strong class="card-title text-left">New Category</strong>
                        ...
                        <div class="card-body">
                           <form action="{{route('admin-category-store')}}" method="post"  enctype="multipart/form-data" class="new-user"> 
                           		@csrf

                           		<div class="row mt-2">
	                           		<div class="form-group col-md-4">
	                                    <label for="name" class="control-label mb-1">Category Name <small class="text-danger">*</small></label>
	                                    <input id="name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Category Name" required="" value="{{old('name')}}">
	                                     <span class="text-danger"> {{ $errors->first('name') }}</span>
	                                </div>
	                                <div class="form-group col-md-4">
	                                    <label for="time" class="control-label mb-1">Time</label>
	                                    <input id="time" name="time" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="Time"  value="{{old('time')}}">
	                                    <span class="text-danger"> {{ $errors->first('time') }}</span>
	                                </div>
	                                <div class="form-group col-md-4">
	                                    <label for="question_no" class="control-label mb-1">Question No</label>
	                                    <input id="question_no" name="question_no" type="number" class="form-control" aria-required="true" aria-invalid="false" placeholder="0"  value="{{old('question_no')}}">
	                            ...
	                            <div class="row mt-2">
	                            	 <div class="form-group col-md-4">
	                                    ...
	                                    <input id="passed" name="passed" type="number" class="form-control" aria-required="true" aria-invalid="false" placeholder="100"  value="{{old('passed')}}">
	                                ...
	                                <div class="form-group col-md-4">
	                                    <label for="topic" class="control-label mb-1" title="How Many Times Candidate Take This Quiz">Attempted</label>
	                                   	<input type="number" name="attempted" class="form-control" value="{{ old('attempted') }}" title="How Many Times Candidate Take This Quiz">
