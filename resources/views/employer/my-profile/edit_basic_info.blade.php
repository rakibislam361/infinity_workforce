 <div class="modal fade" id="basic_info" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('emp-user-profile-update',$user->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-2">
	                            ...
	                            <div class="row mt-2">
	                                ...
	                                <div class="form-group col-md-6">
	                                    ...
	                                    <input id="password" name="password" type="password" class="form-control" placeholder="New Password" value="" autocomplete="off">
