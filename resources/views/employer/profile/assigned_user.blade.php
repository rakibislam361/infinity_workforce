    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title float-left" id="mediumModalLabel">Add New User</h5>
                <button type="button" class="close float-right" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{url('employer/user/store')}}" method="post"  enctype="multipart/form-data" class="new-user"> 
                    @csrf
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                        ...
                        <input type="hidden" value="{{@$employer->office->id}}" name="company_id">
