	...
	<form method="POST" action="{{ route('register') }}">
	                ...
	                <div class="row  mb-3">
	                	<div class="col-md-12 text-center">
	                		<h4>
				               	INFINITY WORKFORCE MEMBER APPLICATION
				            </h4>
	                	</div>
	                </div>
	                ...
	                <div class="form-group row">
	                    <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }} <br/><small class="text-info">Password length minimum 6</small></label>
