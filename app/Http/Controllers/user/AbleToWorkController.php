...
class AbleToWorkController extends Controller
{
    ...
    {
        $user=Auth::user();
        return view('user.available-to-work.index',compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       if($able->count()==1){
        ...
        return redirect()->route('user-profile')->with('success','Successfully Updated!')->with('active',5);
        //return redirect()->route('user-wish-to-work')->with('success','Successfully Updated!');
